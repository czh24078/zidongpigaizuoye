...
TABLES = [
    ...
    (
        ...
        CREATE TABLE IF NOT EXISTS `questions` (
            ...
            `options`         TEXT        NULL,
            `analysis`        TEXT        NULL,
            `subject`         VARCHAR(20) NOT NULL DEFAULT '其他',
            PRIMARY KEY (`id`),
            INDEX (`exam_id`),
...
if cursor.fetchone()[0] > 0:
    ...
    seeds = [
        ...
        (11, None, '5',
         ...
         'AI生成题目', 4, '语文', '2026-05-24 18:20:00'),
        (12, None, '4',
         ...
         'AI生成题目', 5, '语文', '2026-05-24 18:20:01'),
    ]
    cursor.executemany(
        "INSERT INTO question_bank "
        "(id, exam_id, question_no, question_text, standard_answer, analysis, exam_filename, bank_no, subject, added_at) "
