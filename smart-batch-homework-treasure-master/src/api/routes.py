...
_SUBJECT_KEYWORDS = {
    ...
    "数学": [
        ...
        "行程", "浓度", "年龄", "钟表", "余数",
        # 小学基础（数数、认数、读数）
        "看图", "看图列式", "看图写数", "数一数", "填一填", "算一算",
        "画一画", "圈一圈", "连一连", "涂一涂", "比一比", "排一排",
        "个位", "十位", "百位", "千位", "万位", "数位", "计数单位",
        "读作", "写作", "组成", "分成", "合起来",
        "一共有", "还剩", "原来", "现在", "比多少", "相差",
        "一共多少", "还剩多少", "谁多谁少", "多多少", "少多少",
        "第几", "从左往右", "从右往左", "从前往后", "从后往前",
        "相邻", "中间", "之间", "前面", "后面", "上面", "下面",
        "估一估", "大约", "大概", "接近", "整十", "整百", "整千",
        # 加减乘除基础
        "加减法", "进位", "退位", "凑十法", "破十法", "平十法",
        "加法口诀", "减法口诀",
        "乘法口诀", "九九表", "乘法表",
        "除法口诀",
        "加数", "和", "被减数", "减数", "差",
        ...
        "几分之几", "分母", "分子", "分数线",
        "几分之一", "三分之一", "四分之一", "五分之一",
        "同分母", "异分母", "分数加减", "分数乘法", "分数除法",
        "分数大小", "分数比较", "分数和小数", "分数化成小数",
        # 几何图形（小学）
        "点", "线", "线段", "射线", "直线", "曲线",
        "端点", "相交", "交点", "延伸", "延长线",
        "角", "顶点", "边", "直角", "锐角", "钝角", "平角", "周角",
        "直角符号", "量角器", "画角", "测角",
        "平行", "垂直", "相交", "互相平行", "互相垂直",
        "正方形", "正方体", "长方形", "长方体",
        "对边", "邻边", "长", "宽", "棱", "顶点", "面",
        "正方形面积", "长方形面积", "三角形面积", "梯形面积",
        "平行四边形面积", "圆的面积", "圆的周长",
        "组合图形", "阴影部分", "不规则图形",
        # 方向与位置
        "东", "南", "西", "北", "东北", "东南", "西北", "西南",
        ...
        "时差", "24时计时法", "12时计时法",
        "年月日", "平年", "闰年", "大月", "小月",
        "星期", "天", "日", "季度", "上半年", "下半年", "全年",
        # 生活应用
        "购物", "买东西", "付钱", "找零", "花了多少钱", "还剩多少钱",
        "贵", "便宜", "涨价", "降价", "原价", "现价", "优惠", "折扣",
        "每人", "每个", "每辆", "每班", "每排", "每行",
        "够不够", "够吗", "能吗", "可以吗",
        "至少", "最多", "最少", "最大", "最小",
        "估算够不够", "大约需要", "准备多少钱",
        # 代数（初中）
        "代数", "代数式", "单项式", "多项式", "整式", "分式",
        "系数", "次数", "项数", "常数项", "同类项", "合并同类项",
        "开方", "平方根", "算术平方根", "立方根", "平方根", "根式",
        "根号", "被开方数", "根指数", "最简根式",
        "一元一次方程", "二元一次方程", "一元二次方程",
        "三元一次", "方程组", "消元", "代入法", "加减法", "换元法",
        # 平面几何（初中）
        "对顶角", "邻补角", "同位角", "内错角", "同旁内角",
        "余角", "补角", "互余", "互补",
        "角平分线", "中线", "高线", "中位线", "垂直平分线",
        "等腰三角形", "等边三角形", "直角三角形", "锐角三角形", "钝角三角形",
        "等腰梯形", "直角梯形",
        "内心", "外心", "重心", "垂心",
        "相交弦", "弦", "弧", "优弧", "劣弧", "圆心角", "圆周角",
        "切线", "割线", "外接圆", "内切圆", "外切", "内接",
        # 三角函数与坐标系
        "正弦", "余弦", "正切", "余切", "特殊角", "三角比",
        "原点", "x轴", "y轴", "横坐标", "纵坐标", "第一象限", "第二象限",
        "函数图像", "一次函数图像", "二次函数图像",
        "开口", "对称轴", "顶点", "最大值", "最小值", "增减性",
        "自变量", "因变量", "定义域", "值域", "取值范围",
    ],
    "物理": [
        # 力学
